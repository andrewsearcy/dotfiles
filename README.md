# andrewsearcy does dotfiles - forked from jldeen's repo
...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/andrewsearcy/dotfiles/master/configure.sh)"
```
...
[Fork holman's](https://github.com/jldeens/dotfiles/fork) or [Fork mine](htps://github.com/andrewsearcy/dotfiles/fork), remove what you don't
...
There is one "master" branches here: MacOS.

Run this:

```sh
git clone https://github.com/andrewsearcy/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
[open an issue](https://github.com/andrewsearcy/dotfiles/issues) on this repository
and I'd love to get it fixed for you!

## thanks

I forked [Ryan Bates](http://github.com/jldeens)' excellent
[dotfiles](http://github.com/jldeens/dotfiles) for a couple years before the
